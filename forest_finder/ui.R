...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    div(
      ...
      absolutePanel(
        ...
        pickerInput(
          ...
          label = "Basemap:",
          choices = c(
            "Open Street Map (OSM)" = providers$OpenStreetMap,
    ...
    # control toggle
    div(
      style = "position: fixed; top: 60px; right: -270px; z-index: 1000;",
      prettyToggle(
        inputId = "toggleControls2",
        value = TRUE,
        label_on = NULL,
        icon_on = icon("xmark"),
        status_on = "primary",
